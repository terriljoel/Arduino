...
// Arduino Nano ESP32 built-in LEDs (corrected pin mapping)
#define LED_RED 16      // RGB Red pin (was 14, corrected)
#define LED_GREEN 14    // RGB Green pin (was 16, corrected)  
